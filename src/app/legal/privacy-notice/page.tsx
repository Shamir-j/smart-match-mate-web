          ...
          <Col xs={24} lg={18}>
            <Space orientation="vertical" size="large" style={{ width: "100%" }}>
              ...
              <div id="content">
                ...
                <Paragraph>
                  <Text strong>Public Nature of Content:</Text> Profiles, photos, and other content you post are visible to other users of the Service. We cannot control how other users or third parties use your content once it is public (e.g., screenshots).
                </Paragraph>
                <Paragraph>
                  <Text strong>Moderation:</Text> We use automated systems and human moderators to review content for violations of our policies. Content that violates our standards may be removed, and we may use such content to train our safety algorithms.
                </Paragraph>
              </div>
