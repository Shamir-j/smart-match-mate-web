...
// Props interface for client component
...
export default function UserProfileClient({ initialUserData, userId }: UserProfileClientProps) {
  const router = useRouter();
  
  const [user, setUser] = useState<UserProfile | null>(initialUserData);
  ...
  useEffect(() => {
    ...
    // Use initial data from server component (ISR optimized)
    if (initialUserData) {
      setUser(initialUserData);
      return;
    }
    
    // Fallback: In a real app, you would fetch user data from your API
