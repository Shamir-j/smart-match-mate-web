    ...
    return Array.from({
        length: count
            ...
            user_account_information: {
                user_account_first_name: names[i % names.length],
                user_account_profile_picture_url: `https://i.pravatar.cc/400?u=${i}`,
                age: 24 + i % 8,
...
const generateFakeAd = ()=>({
        ...
        nativeAd: {
            ...
            body: 'Get unlimited likes and see who likes you',
            cta: 'Upgrade Now'
        }
    });
function SwipePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SwipePage.useEffect": ()=>{
            setTimeout({
                "SwipePage.useEffect": ()=>{
                    setProfiles(generateFakeUsers(5));
                    setIsLoading(false);
                }
            }["SwipePage.useEffect"], 1500);
        }
    }["SwipePage.useEffect"], []);
        ...
        "SwipePage.useEffect": ()=>{
            if (profiles.length === 0 && !isLoading) {
                const timer = setTimeout({
                    "SwipePage.useEffect.timer": ()=>{
                        setIsLoading(true);
                        setSwipeCount(0);
                        setTimeout({
                            "SwipePage.useEffect.timer": ()=>{
                                setProfiles(generateFakeUsers(6));
                                setIsLoading(false);
                            }
                        }["SwipePage.useEffect.timer"], 1200);
                    }
    ...
    // Ad injection
    const injectAd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SwipePage.useCallback[injectAd]": ()=>{
            setProfiles({
                "SwipePage.useCallback[injectAd]": (prev)=>[
                        generateFakeAd(),
                        ...prev
                    ]
            }["SwipePage.useCallback[injectAd]"]);
    ...
    const handleSwipe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SwipePage.useCallback[handleSwipe]": (direction)=>{
            const top = profiles[0];
            if (top?.type === 'user') {
                console.log(`Swiped ${direction} on ${top.user_account_information.user_account_first_name}`);
            }
            setSwipeCount({
                "SwipePage.useCallback[handleSwipe]": (c)=>{
                    const next = c + 1;
            ...
            setProfiles({
                "SwipePage.useCallback[handleSwipe]": (prev)=>prev.slice(1)
            }["SwipePage.useCallback[handleSwipe]"]);
        }
    }["SwipePage.useCallback[handleSwipe]"], [
        profiles,
            ...
            const interval = setInterval({
                "SwipePage.useEffect.interval": ()=>{
                    if (pendingSwipe.current && !isDragging.current) {
                        handleSwipe(pendingSwipe.current);
                        pendingSwipe.current = null;
                    }
                }
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$typography$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"].Title, {
                                    ...
                                    children: [
                                        ...
                                        ", ",
                                        profile.user_account_information.age
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/src/app/(authenticated)/swipe/page.tsx",
                                    lineNumber: 282,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$typography$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"].Text, {
                                    type: "secondary",
                                    children: profile.user_account_information.city
                                }, void 0, false, {
                                    fileName: "[project]/src/app/(authenticated)/swipe/page.tsx",
                                    lineNumber: 285,
                                    columnNumber: 29
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: hasProfiles ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    visibleProfiles.map((profile, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProfileCard, {
                            profile: profile,
                            index: index
                        }, profile.id, false, {
                            fileName: "[project]/src/app/(authenticated)/swipe/page.tsx",
                ...
                image: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    style: {
                        ...
                        borderRadius: '50%',
                        background: '#ddd',
                        backgroundImage: 'ur[](https://i.pravatar.cc/300?u=self)',
                ...
                description: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$typography$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"].Text, {
                    ...
                    children: "No one new around you."
                }, void 0, false, {
                    fileName: "[project]/src/app/(authenticated)/swipe/page.tsx",
                    lineNumber: 399,
                    columnNumber: 29
...
_s(SwipePage, "5dHXsBZ3oMPEAz64vf6InPAgMx8=", false, function() {
    return [
...
//# sourceMappingURL=src_app_%28authenticated%29_swipe_page_tsx_1ea59ac2._.js.map