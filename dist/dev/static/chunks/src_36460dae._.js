...
/* ------------------------------------------------------------------ */ /*  Desktop left panel – matches grid (Tinder style)                  */ /* ------------------------------------------------------------------ */ const DesktopSidebar = ()=>{
    const matches = [
        ...
        // … (rest of the mock list – keep the same URLs)
        {
            id: '2',
            name: 'Tiffany',
...
_c = DesktopSidebar;
/* ------------------------------------------------------------------ */ /*  Mobile bottom navigation                                           */ /* ------------------------------------------------------------------ */ const MobileBottomNav = ({ pathname, onNavigate })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
            position: 'fixed',
            bottom: 0,
            left: 0,
...
//# sourceMappingURL=src_36460dae._.js.map