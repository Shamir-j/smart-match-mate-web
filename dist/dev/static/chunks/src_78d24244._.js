    ...
    if (profile.type === 'ad') {
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                isTopCard && swipeX > 50 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    style: {
                        position: 'absolute',
                        top: 80,
                        left: 32,
 ...
 */ const SwipePage = ()=>{
    ...
    const [swipeY, setSwipeY] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
   ...
   */ const handleMouseDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SwipePage.useCallback[handleMouseDown]": (e)=>{
    ...
    }["SwipePage.useCallback[handleMouseDown]"], [
        hasProfiles
    ]);
    const handleTouchStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SwipePage.useCallback[handleTouchStart]": (e)=>{
            if (!hasProfiles) return;
            setIsDragging(true);
    ...
    }["SwipePage.useCallback[handleTouchStart]"], [
        hasProfiles
    ]);
    const handleMouseMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SwipePage.useCallback[handleMouseMove]": (e)=>{
    ...
    }["SwipePage.useCallback[handleMouseMove]"], [
        isDragging
    ]);
    const handleTouchMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SwipePage.useCallback[handleTouchMove]": (e)=>{
            if (!isDragging) return;
            const touch = e.touches[0];
    ...
    }["SwipePage.useCallback[handleTouchMove]"], [
        isDragging
    ]);
    const handleDragEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SwipePage.useCallback[handleDragEnd]": ()=>{
            if (!isDragging) return;
            setIsDragging(false);
            if (Math.abs(swipeX) > SWIPE_THRESHOLD) {
                ...
                }["SwipePage.useCallback[handleDragEnd]"], 300);
            } else {
                // Snap back to center
                setSwipeX(0);
                setSwipeY(0);
   ...
   */ const handleChoice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SwipePage.useCallback[handleChoice]": (direction)=>{
            ...
            }["SwipePage.useCallback[handleChoice]"], 300);
        }
    }["SwipePage.useCallback[handleChoice]"], [
        hasProfiles,
        handleSwipeComplete
...
_s(SwipePage, "CCghnQLxS5UpXe5W5G9ATbJh/6k=");
_c = SwipePage;
...
//# sourceMappingURL=src_78d24244._.js.map